...
import static cn.com.larunda.safebox.fragment.BoxAddInfoFragment.material_text;
import static cn.com.larunda.safebox.fragment.BoxAddInfoFragment.name_text;
import static cn.com.larunda.safebox.fragment.BoxAddInfoFragment.protect_text;
import static cn.com.larunda.safebox.fragment.BoxAddInfoFragment.size_text;
import static cn.com.larunda.safebox.fragment.BoxAddInfoFragment.url;
import static cn.com.larunda.safebox.fragment.BoxAddSafeFragment.endDateText;
import static cn.com.larunda.safebox.fragment.BoxAddSafeFragment.endTimeText;
import static cn.com.larunda.safebox.fragment.BoxAddSafeFragment.levelText;
import static cn.com.larunda.safebox.fragment.BoxAddSafeFragment.lockText;
import static cn.com.larunda.safebox.fragment.BoxAddSafeFragment.startDateText;
import static cn.com.larunda.safebox.fragment.BoxAddSafeFragment.startTimeText;

public class BoxAddActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        button = findViewById(R.id.box_init_button);
    ...
    private void sendPutRequest(String url,String name, String material, String size, String protect, String level, String startData, String startTime, String endData, String endTime, String lock) {
        ...
        try {
            ...
            HttpUtil.sendPutRequestWithHttp(MESSAGE_URI + id + Util.TOKEN + token, jsonObject.toString(), new Callback() {
                @Override
                public void onFailure(Call call, IOException e) {
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(BoxAddActivity.this, "网络异常", Toast.LENGTH_SHORT).show();
                    ...
                    if (Util.isGoodJson(content)) {
                        ...
                        if (result != null && result.error == null) {
                            ...
                            runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    Intent intent = new Intent(BoxAddActivity.this, LoginActivity.class);
